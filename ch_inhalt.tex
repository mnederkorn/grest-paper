...
We can take (2) and rescale all the weights by W, such that all weights are $>=0$:
\begin{align*}
	&v(v_0)+W=\\
...
\end{align*}
Similarly, we can rescale by -W, such that all weights are $<=0$ and in total we arrive at:
\begin{align*}
